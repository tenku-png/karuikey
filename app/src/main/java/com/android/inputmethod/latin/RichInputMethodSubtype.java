...
public class RichInputMethodSubtype {
    ...
    // Standalone fallback used when no framework subtype is supplied.
    ...
    // Kept only as a structural AOSP fallback; Karuikey does not expose an emoji keyboard.
    ...
    public static RichInputMethodSubtype getNoLanguageSubtype() {
        ...
        if (noLanguageSubtype == null) {
            noLanguageSubtype = PLACEHOLDER_NO_LANGUAGE_SUBTYPE;
        }
        if (noLanguageSubtype != null) {
    ...
    public static RichInputMethodSubtype getEmojiSubtype() {
        ...
        if (emojiSubtype == null) {
            emojiSubtype = PLACEHOLDER_EMOJI_SUBTYPE;
        }
        if (emojiSubtype != null) {
