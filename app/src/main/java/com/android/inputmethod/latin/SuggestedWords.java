...
public class SuggestedWords {
    ...
    public static class SuggestedWordInfo {
        ...
        @Deprecated
        public final Object mSourceDict;
         ...
         * flags.
         * @param sourceDict Optional source marker; the standalone core has no dictionary engine.
        ...
        public SuggestedWordInfo(final String word, final String prevWordsContext,
                ...
                final Object sourceDict, final int indexOfTouchPointOfSecondWord,
        ...
        @Deprecated
        public Object getSourceDictionary() {
            return mSourceDict;
        }
